package nuclear.utils.render.shader.core;

import lombok.SneakyThrows;
import net.minecraft.util.ResourceLocation;
import nuclear.utils.misc.FileUtil;
...
public class Shader {
    ...
    public Shader(String path) {
        init(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("nuclear/shader/impl/" + path + ".frag")).getInputStream()));
    }
    ...
    private void init(String source) {
        ...
        ARBShaderObjects.glAttachObjectARB(program, createShader(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("nuclear/shader/vertex.vert")).getInputStream()), GL_VERTEX_SHADER));
