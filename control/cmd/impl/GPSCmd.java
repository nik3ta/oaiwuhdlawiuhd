...
@CmdInfo(name = "gps", description = "Прокладывает путь до координат")
public class GPSCmd extends Cmd {
    ...
    public static void drawArrow(MatrixStack stack) {
        if (enabled) {
            ...
            int clr = getColorByName("primaryColor");
            GlStateManager.rotatef(90.0F, 0.0F, 0.0F, 1.0F);
            RenderUtils.Render2D.drawImageAlph(new ResourceLocation("nuclear/images/arrow/arrow.png"), -8, 4, 16F, 16F, new Vector4i(ColorUtils.setAlpha(clr, 200), ColorUtils.setAlpha(clr, 200), ColorUtils.setAlpha(clr, 200), ColorUtils.setAlpha(clr, 200)));
            Fonts.newcode[13].drawCenteredStringWithOutline(stack, (int)dst + "m", 0, 6, -1);
