...
@CmdInfo(name = "vclip", description = "Телепортирует вас вверх")
public class VClipCmd extends Cmd {
    ...
    public void run(String[] args) throws Exception {
        ...
        try {
            ...
            ClientUtils.sendMessage(Translated.isRussian() ? "Please enter a valid number for height" : "Введите корректное число для высоты");
        }
    }
